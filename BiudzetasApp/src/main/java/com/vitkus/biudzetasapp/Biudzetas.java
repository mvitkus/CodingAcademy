...
//		}
	...
	public void gautiPajamuIrasa() {
		...
		for(int i = 0; i < pajamos.size(); i++) {  
		    ...
		    System.out.print(pajamos.get(i).getKategorija()+") "+"Suma: "+pajamos.get(i).getSuma()+"Eur | Data: "+dateFormat.format(pajamos.get(i).getData())+" | Paskirtis "+pajamos.get(i).getPapildomaInfo());
...
//		}
	...
	public void gautiIslaiduIrasa() {
		...
		for(int i = 0; i < islaidos.size(); i++) {  
		    ...
		    System.out.print(islaidos.get(i).getKategorija()+") "+"Suma: "+islaidos.get(i).getSuma()+"Eur | Data: "+dateFormat.format(islaidos.get(i).getData())+" | Paskirtis: "+islaidos.get(i).getPapildomaInfo());
